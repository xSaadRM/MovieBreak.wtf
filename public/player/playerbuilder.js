...
function Playerjs(options) {
  ...
  function Init2() {
    ...
    o.container.oncontextmenu = function ContextMenu(e) {
      ...
      if (v.rc_custom == 1) {
        if (exist(v.rc_label)) {
          if (trim(v.rc_label) != "") {
            o.brand = "MovieBreak.wtf";
            exist(v.rc_labelurl)
              ? (o.brandurl = "MovieBreak.wtf")
              : "MovieBreak.wtf";
            v.rc_label == "MovieBreak.wtf"
              ? (o.brandurl = "MovieBreak.wtf")
              : "MovieBreak.wtf";
          }
        }
            ...
            if ((v["rm" + i] == 1 && v.rightmenu == 1) || i == 9) {
              if (
                ...
                if (i == 9) {
                  if (v.rc_nobrand != 1) {
                    tmp.innerText =
                      "MovieBreak" + (v.rc_version == 1 ? " " + o.version : "");
                  } else {
                    break;
                  }
                } else {
    ...
    function RightClick(e) {
      ...
      if (i > 0) {
        if (i == 9) {
          o.brandurl != "" ? window.open("https://MovieBreak.wtf/") : "";
        } else {
          var x = v["rm" + i + "a"];
          if (x) {
            if (x.indexOf("api:") == 0) {
  ...
  function Ready() {
    ...
    if (!o.system.mobile) {
      ...
      if (v.sy == 1 && v.click0timeout == 1) {
        o.mediacontainer.addEventListener("dblclick", rC, false);
      }
    }
    MainUpdateSize();
    if (v.chromecast) {
  ...
  function ScreenClick(e) {
    ...
    if (o.click_t && v.screenclick == 1 && !o.system.tv) {
      ...
      if (v.click0timeout == 1 || (v.sy == 0 && v.hotkey.seeksides != 1)) {
        ScreenClick2();
      } else {
